...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `products`(name, code, type, price, image, more_info) VALUES('$p_name', '$p_code', '$p_type', '$p_price', '$p_image', '$p_info')") or die('query failed');
...
<h3>Add product</h3>
   <div class="input_table">
      ...
      <div class="qty_box" style="width: 100%;">
         ...
         <input type="number" name="p_qty" min="0" placeholder="product qty" class="box p_qty_class" required>
         <input type="submit" value="Add" class="qty_btn" onclick="add_new_info();" style="width: 20%;">
         <input type="submit" value="remove" class="qty_btn" onclick="remove_new_info();" style="width: 20%;">
      </div>
      ...
      <input type="number" name="p_qty_list" min="0" placeholder="product qty" class="box p_qty_list" required>
