   ...
   <form class="add-product-form" enctype="multipart/form-data"  method="POST">
      ...
      <div class="input_table">
         ...
         <div id='step1form' class='stepform-class'>
            ...
            <input type="text" name="new_p_code" value="<?php echo $_COOKIE["std_code"];?>" placeholder="product code" class="box_0 p_code">
